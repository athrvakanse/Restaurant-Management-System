...
// src/components/manager/AddSubcategoryComponent.jsx
...
function AddSubcategoryComponent() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Your backend expects Subcategory object with c_id as a nested object
      await axios.post("http://localhost:8080/api3/subcategories/save", {
        s_name,
        c_id: { c_id: categoryId },
      });
  ...
  return (
    <div className="container mt-4">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <Link
          to={`/manager/dashboard/subcategory/view/${categoryId}`}
